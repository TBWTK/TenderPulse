...
| Agent-assisted pilot eval | Blind pre-evaluation «Чистой территории» на ≥50 real ЕИС notices | frozen lineage sample, separate labels/predictions, reproducible metrics, human review packet | active |
